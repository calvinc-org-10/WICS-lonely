...
FormNameToURL_Map['frmcountentry'.lower()] = ('CountEntryForm', None) # forms.CountEntryForm)
FormNameToURL_Map['frmUploadCountEntry'.lower()] = ('UploadActualCountSprsht', None) # forms.spreadsheet.UploadActCountSprsht)
FormNameToURL_Map['frmcountsummarypreview'.lower()] = ('CountSummaryReport', None) #forms.fmActualCounts.rptCountSummary)
...
FormNameToURL_Map['frmmaterial'.lower()] = ('MatlForm', None) # forms.MaterialForm)
...
FormNameToURL_Map['matllistupdt'.lower()] = ('', None) #forms.UpdateMatlListfromSAP)
FormNameToURL_Map['frmRandCountScheduler'.lower()] = (None, None)

FormNameToURL_Map['frmCountScheduleEntry'.lower()] = ('CountScheduleForm', None) #forms.CountScheduleRecordForm)
...
FormNameToURL_Map['PartTypeFm'.lower()] = ('PartTypeForm', None) #forms.PartTypesForm)
